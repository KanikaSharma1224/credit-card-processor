...
public class JwtTokenUtil implements Serializable  {
	...
	public JwtTokenUtil() {
		// should be read from file system or referred from the cloud service as a secret
	...
	public String getEmailFromToken(String token) {
		return Jwts.parserBuilder().setSigningKey(privateKey).build().parseClaimsJws(token).getBody().get("email").toString();
	}
	...
	public String generateToken(Users userid) {
		Map<String, Object> claims = new HashMap<>();
		claims.put("userId", userid.getUserName());
		claims.put("email", userid.getUserName());
